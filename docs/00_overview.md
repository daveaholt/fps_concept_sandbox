...
- Post-M5: the three graybox ramps were floating. A 1 m thick slab rotated to 20° puts its walkable face `0.5·cos(20°) ≈ 0.47 m` above its centre plane, and the centre plane was authored to reach y=0 — so every ramp began with a half-metre step. Infantry can step 0.10 m and the tank has 0.30 m of wheel-to-hull clearance, so both simply collided with it. All three slabs (and the 20° landing) were lowered by that offset; the Hilltop junction now meets at exactly y=15.
