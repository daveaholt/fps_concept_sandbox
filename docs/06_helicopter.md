...
- **M7: hard landings now cost hull (04).** The damage threshold is 6 m/s, not the 4 m/s in the acceptance criterion above — that number is about the skids not bounce-flipping, and a 1.2 m drop arrives at 4.85 m/s, which should not hurt. So below 4 is a clean landing, 4-6 is untidy but free, and past 6 the excess is squared. A 40 m fall destroys the aircraft.
